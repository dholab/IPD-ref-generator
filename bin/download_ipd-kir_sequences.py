...
with open("ipd-kir-nhp-" + datetime.today().strftime('%Y-%m-%d') + ".gbk", "a") as all_nhp:

  # create output genbank file for rhesus only
  with open("ipd-kir-mamu-" + datetime.today().strftime('%Y-%m-%d') + ".gbk", "a") as mamu:

    # create output genbank file for cyno only
    with open("ipd-kir-mafa-" + datetime.today().strftime('%Y-%m-%d') + ".gbk", "a") as mafa:

      # create output genbank file for mane only
      with open("ipd-kir-mane-" + datetime.today().strftime('%Y-%m-%d') + ".gbk", "a") as mane:
