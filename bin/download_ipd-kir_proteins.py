...
with open("ipd-kir-nhp-prot-" + str(ipd_number) + ".fasta", "a") as all_nhp:

  # create output genbank file for rhesus only
  with open("ipd-kir-mamu-prot-" + str(ipd_number) + ".fasta", "a") as mamu:

    # create output genbank file for cyno only
    with open("ipd-kir-mafa-prot-" + str(ipd_number) + ".fasta", "a") as mafa:

      # create output genbank file for mane only
      with open("ipd-kir-mane-prot-" + str(ipd_number) + ".fasta", "a") as mane:
